...
When configuring the lambda, be sure to define the REGION environment var (which is, shockingly, the AWS region your instances are in) and the INSTANCES env var, which is a space-delimited string list of instance ids in that region, e.g.: "i-0123456789ABCDEF0 i-0FEDCBA9876543210 < <i>another-instance-id</i> > < <i>yet-another-instance-id</i> >".
