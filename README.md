This is a lambda function handler that will be called at the start and end of each trading day to start the EC2 servers you use in your trading system. You will need to create the AWS Lambda Function and upload a zip file (run zip-lambda.sh to do this). You will also need to give the role you use to run the lambda two permissions: StartInstances and StopInstances.
